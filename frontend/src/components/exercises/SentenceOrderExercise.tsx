...
/**
 * Tap words in the bank to move them into the answer area, tap them again to
 * send them back. Check is enabled only once the bank is empty, and the answer
 * is submitted as space separated words.
 *
...
export default function SentenceOrderExercise({
  ...
  return (
    <div className="flex w-full flex-col items-center gap-2 p-4">
      <h3 className="text-ink">Arrange the words in correct order</h3>

      <p className="text-lg text-ink-muted">{exercise.question}</p>
